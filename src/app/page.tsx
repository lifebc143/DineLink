...
function ProfileV2({ onOpenPrd, onOpenMyEvents, userName, onLogout, isAdmin, onOpenAdmin }: { onOpenPrd: () => void; onOpenMyEvents: () => void; userName?: string | null; onLogout: () => Promise<void>; isAdmin: boolean; onOpenAdmin: () => void }) {
...
export default function Home() {
  ...
  const [sessionUser, setSessionUser] = useState<{ displayName?: string | null; name?: string | null; role?: "member" | "moderator" | "admin" } | null>(null);
