...
type Snapshot = { id: string; scheduleKey: string; status: "succeeded"; trigger: "scheduled" | "manual"; checksumSha256: string | null; byteSize: number | null; tableCounts: Record<string, number>; createdAt: string; completedAt: string | null; storage?: { provider: "Private S3"; objectKey: string | null; downloadAvailable: boolean } };
